  ...
  <div id="wrap">
    ...
    <div class="float-r right">
	  ...
	  <?php
		$no=$_POST['no'];
		$max=$no;
		echo "<form method=post action=imgaction2.php enctype='multipart/form-data'>";
		echo "<table border='0' width='400' align=center>";
		$a=1;
		while($a<=$max)
		{
		echo "<tr><td>Image $a</td><td>
		<input type=file name='images[]' class='bginput'></td></tr>";
		$a++;
		}
		echo "<tr><td colspan=2 align=center><input type=submit value='Add Images'></td></tr>"; 
		echo "</form> </table>";
		?>
		</p>
      </div>
