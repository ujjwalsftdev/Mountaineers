  ...
  <div id="wrap">
    ...
    <div class="float-r right">
	  ...
	  <br>
	   ...
	   <form  action="advaction.php" method="post">

	   <table align="center">
	   <tr><td align="center"><font face="verdana" color="red"><b>POST YOUR ADVENTURE</b></font></td></tr>
	   <tr><td><textarea rows="10" cols="50" name="adv">  </textarea></td></tr>
